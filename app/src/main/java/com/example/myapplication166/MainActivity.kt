    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.about_menu_item -> {
                // Create the intent to start AboutActivity
                val intent = Intent(this, AboutActivity::class.java)
                // Put the about text into the intent as an extra
        ...
        if (menu != null) {
            ...
            if (themeSwitchItem != null) {
                if (AppCompatDelegate.getDefaultNightMode() == AppCompatDelegate.MODE_NIGHT_YES) {
                    ...
                    themeSwitchItem.setIcon(R.drawable.ic_launcher_foreground) // Replace with your light mode icon
                } else {
                    themeSwitchItem.title = "Сменить на тёмную"
                    themeSwitchItem.setIcon(R.drawable.ic_launcher_background) // Replace with your dark mode icon
                }
            }
        }
    }
